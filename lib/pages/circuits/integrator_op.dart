...
class IntgratorOp extends StatefulWidget {
  const IntgratorOp({
    Key? key,
  }) : super(key: key);
  @override
  _IntgratorOpState createState() => _IntgratorOpState();
}

class _IntgratorOpState extends State<IntgratorOp> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Integrator using Opamp"),
      ),
      body: ListView(
        children: [
          Column(
            ...
            children: [
              const Image(
                image: AssetImage('assets/images/integrator.png'),
              ),
              ElevatedButton(
                onPressed: () async {
                  await fetchData();
