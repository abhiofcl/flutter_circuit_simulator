...
class NegPosClamper extends StatefulWidget {
  // final int circuitkey;

  const NegPosClamper({Key? key}) : super(key: key);
  @override
  _NegPosClamperState createState() => _NegPosClamperState();
}

class _NegPosClamperState extends State<NegPosClamper> {
  String _showValue = '';
  ...
  void initState() {
    super.initState();
    _apiUrl = '${Constants.apiUrl}/api/biasedclamper/3';
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Positive biased Negative clamper"),
      ),
      body: Stack(
        children: [
          Column(
