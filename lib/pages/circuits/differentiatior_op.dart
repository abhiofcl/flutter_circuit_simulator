...
class DifferentiatorOp extends StatefulWidget {
  const DifferentiatorOp({
    Key? key,
  }) : super(key: key);
  @override
  _DifferentiatorOpState createState() => _DifferentiatorOpState();
}

class _DifferentiatorOpState extends State<DifferentiatorOp> {
  ...
  void initState() {
    super.initState();
    _apiUrl = '${Constants.apiUrl}/api/opamp/differentiator/1';
  }
