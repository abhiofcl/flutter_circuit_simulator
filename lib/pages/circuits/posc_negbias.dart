...
class PosNegClamper extends StatefulWidget {
  // final int circuitkey;

  const PosNegClamper({Key? key}) : super(key: key);
  @override
  _PosNegClamperState createState() => _PosNegClamperState();
}

class _PosNegClamperState extends State<PosNegClamper> {
  String _showValue = '';
  ...
  void initState() {
    super.initState();
    _apiUrl = '${Constants.apiUrl}/api/biasedclamper/2';
  }
        ...
        children: [
          Column(
            ...
            children: [
              const Image(
                image:
                    AssetImage('assets/images/positive_clamper_neg_bias.png'),
              ),
              ElevatedButton(
                onPressed: () async {
                  await fetchData();
